...
td.td1{width: 15%;}
td.td2{width: 45%;}
td.td2 img, td.td2 input.button-xemthem,td.td2 button.button-xemthem{width: 200px;}
td.td3{width: 20%;}
td.td4{width: 20%;}
@media all and (max-width: 568px)
{
.search_wrapper{margin: 0;}
td.td2 img, td.td2 input.button-xemthem,td.td2 button.button-xemthem{width: 80px;font-size: 12px;}
.table>tbody>tr>td, .table>tbody>tr>th, .table>tfoot>tr>td, .table>tfoot>tr>th, .table>thead>tr>td, .table>thead>tr>th{padding: 5px 3px !important;}
.search_dates_arrival,.search_dates_departure{margin-right: 0;}
}
	...
	<div id="" class="container">
		<div
            ...
            <?php
					...
					<div class="search_wrapper col-sm-12 col-xs-12">
						...
						<table class="table" style="color:; text-align: left;">
							<thead>
								<tr style="color: blue">
									<th class="td1"></th>
									<th class="td2"></th>
									<th class="td3">Ngày Thường</th>
									<th class="td4">Ngày Lễ</th>
								</tr>
							</thead>
							<tbody style="font-weight:">
								<tr class="success">
									<td class="td1" width="" style="vertical-align: middle;"><input	type="checkbox" name="check_list[]" value="Superior"> Superior</td>
									<td class="td2" style="vertical-align: middle; text-align: center;"><img src="http://bietthulehoang.com/images/gallery/gallery09/img0901.jpg" /><br />
										<input type="button" class="button-xemthem" data-toggle="modal" name="myModal1" value="Xem thêm" data-target="#myModal1" />
										 <!-- Modal -->
												...
												<div class="modal-content">
													...
													<div class="modal-body">
														...
														<div
															...
															<p><span class="glyphicon glyphicon-star" aria-hidden="true"></span> Diện tích: 15m2 - 17m2	</p>
															<p><span class="glyphicon glyphicon-star" aria-hidden="true"></span> Giường King 1m6 x 2m </p>
															<p><span class="glyphicon glyphicon-star" aria-hidden="true"></span> 2 phòng dùng chung 1 toilet bên ngoài</p>
															<p><span class="glyphicon glyphicon-star" aria-hidden="true"></span> View hướng phố </p>
														</div>
									...
									<td class="td3" style="vertical-align: middle;">800.000 VND</td>
									<td class="td4" style="vertical-align: middle;">1.050.000 VND</td>
								</tr>
								<tr class="info">
									<td class="td1" style="vertical-align: middle;"><input	type="checkbox" name="check_list[]" value="Deluxe 1"> Phòng	Deluxe #1</td>
									<td class="td2" style="vertical-align: middle; text-align: center;"><img src="http://bietthulehoang.com/images/gallery/gallery08/img0801.jpg" /><br/>
										<button type="button" class="button-xemthem" data-toggle="modal" name="myModal2" data-target="#myModal2">Xem thêm</button>
										<!-- Modal -->
									...
									<td class="td3" style="vertical-align: middle;">1.250.000 VND</td>
									<td class="td4" style="vertical-align: middle;">1.600.000 VND</td>
								</tr>
								<tr class="info">
									<td class="td1" style="vertical-align: middle;"><input
										type="checkbox" name="check_list[]" value="Deluxe 2"> Phòng
										Deluxe #2</td>
									<td class="td2" style="vertical-align: middle; text-align: center;"><img
										src="http://bietthulehoang.com/images/gallery/gallery09/img0904.jpg" /><br />
										<button type="button" class="button-xemthem" data-toggle="modal" name="myModal3" data-target="#myModal3">Xem
											thêm</button> <!-- Modal -->
								...
								<tr class="info">
									<td class="td1" style="vertical-align: middle;"><input
										...
										Deluxe #3</td>
									<td class="td2" style="vertical-align: middle; text-align: center;"><img
										src="http://bietthulehoang.com/images/gallery/gallery10/img1001.jpg" /><br />
										<button type="button" class="button-xemthem" data-toggle="modal" name="myModal4" data-target="#myModal4">Xem
											thêm</button> <!-- Modal -->
								...
								<tr class="info">
									<td class="td1" style="vertical-align: middle;"><input
										...
										Deluxe #4</td>
									<td class="td2" style="vertical-align: middle; text-align: center;"><img
										src="http://bietthulehoang.com/images/gallery/gallery11/img1102.jpg" /><br />
										<button type="button" class="button-xemthem" data-toggle="modal" name="myModal5" data-target="#myModal5">Xem
											thêm</button> <!-- Modal -->
								...
								<tr class="info">
									<td class="td1" style="vertical-align: middle;"><input
										...
										Deluxe #5</td>
									<td class="td2" style="vertical-align: middle; text-align: center;"><img
										src="http://bietthulehoang.com/images/gallery/gallery12/img1201.jpg" /><br />
										<button type="button" class="button-xemthem" data-toggle="modal" name="myModal6" data-target="#myModal6">Xem
											thêm</button> <!-- Modal -->
								...
								<tr class="warning">
									<td class="td1" style="vertical-align: middle;"><input
										...
										Junior Suite</td>
									<td class="td2" style="vertical-align: middle; text-align: center;"><img
										src="http://bietthulehoang.com/images/gallery/gallery07/img0701.jpg" /><br />
										<button type="button" class="button-xemthem" data-toggle="modal" data-target="#myModal7">Xem thêm</button>
										<!-- Modal -->
									...
									<td class="td3" style="vertical-align: middle;">1.600.000 VND</td>
									<td class="td4" style="vertical-align: middle;">2.000.000 VND</td>
								</tr>
								<tr class="danger">
									<td class="td1" style="vertical-align: middle;"><input
										type="checkbox" name="check_list[]" value="Villa"> Villa</td>
									<td class="td2" style="vertical-align: middle; text-align: center;"><img
										src="http://bietthulehoang.com/images/gallery/gallery01/img0101.jpg" /><br />
										<button type="button" class="button-xemthem" data-toggle="modal" data-target="#myModal8">Xem thêm</button>
										<!-- Modal -->
									...
									<td class="td3" style="vertical-align: middle;">9.450.000 VND</td>
									<td class="td4" style="vertical-align: middle;">12.100.000 VND</td>
								</tr>
								<tr class="danger">
									<td class="td1" style="vertical-align: middle;"><input
										type="checkbox" name="check_list[]" value="Extra person"> Extra person</td>
									<td class="td2" style="vertical-align: middle; text-align: center;"></td>

									<td class="td3" style="vertical-align: middle;">150.000 VND</td>
									<td class="td4" style="vertical-align: middle;">150.000 VND</td>
								</tr>
								<tr class="danger">
									<td class="td1" style="vertical-align: middle;"><input
									...
									<td class="td3" style="vertical-align: middle;">300.000 VND</td>
									<td class="td4" style="vertical-align: middle;">300.000 VND</td>
								</tr>
							</tbody>
						</table>
