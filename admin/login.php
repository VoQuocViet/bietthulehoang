...
<?php 
	...
	mysql_connect("localhost", "bietthuleh_dba", "zxcVBN123");

	mysql_select_db("bietthuleh_db");
...
    </form>
...

			{
				...
				echo "<a href='commentadmin.php' class='btn btn-info'>Vào trang Quản Lý Phản Hồi</a><br /><br />";
