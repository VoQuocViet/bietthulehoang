...
        </div>
        
        <input type="submit" name="submit" class="btn btn-primary" value="Đăng Nhập" formaction="login1.php" formmethod="POST">
    </form>
	</fieldset>
			...
			if(mysql_num_rows($sql)>0)
			{
				...
				echo "<a href='menuadmin.php' class='btn btn-info'>Vào trang AD tại đây</a>";
