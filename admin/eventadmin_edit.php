...
?>
<form action="eventadmin_edit.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
  ...
  <table width="400" border="0" align="center" cellpadding="0" cellspacing="0" align="center">
    <tbody>
      <tr class='title-cart' align="center" bgcolor="#F3AF40" style="font-size: 24px; color: #F9E108; font-family: Constantia, 'Lucida Bright', 'DejaVu Serif', Georgia, serif;">
        <td colspan="2" bgcolor="#F4B17D"><b>Cập Nhật Thông Tin</b><span style="font-size: 24px; text-align: center;"></span></td>
      </tr>
      <tr class='title-cart'>
        <td width="112">ID:</td>
